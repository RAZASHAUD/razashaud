...
export const profile = {
  ...
  available: 'Open to internships, full-time roles and research collaborations',
...
export const projects = [
  {
    ...
    links: [{ label: 'GitHub', url: 'https://github.com/RAZASHAUD' }],
  },
  {
    id: 'saline',
...
export const education = [
  { degree: 'M.Tech, Electronics and Electrical Engineering', school: 'Indian Institute of Technology Guwahati', period: '2026 – 2028', detail: 'Systems, Control and Automation' },
...
export const publications = [
  {
    ...
    url: 'https://ieeexplore.ieee.org/document/10960113',
  },
  {
    ...
    url: 'https://drive.google.com/file/d/12TpDa0jKitrarOSNDMWmOJoZD-_TueRp/view?usp=drivesdk',
  },
  {
    ...
    url: 'https://drive.google.com/file/d/1BaZPNuAtWbu3QiNDepIExd2Qh71l9xR_/view?usp=drivesdk',
  },
];
...
export const faq = [
  { q: ['available', 'availability', 'join', 'notice', 'start', 'when can'], a: `${profile.available}. Currently doing an M.Tech at IIT Guwahati, 2026 to 2028.` },
  ...
  { q: ['iit', 'guwahati', 'm.tech', 'mtech', 'masters', 'specialization'], a: 'M.Tech in Electronics and Electrical Engineering at IIT Guwahati, 2026–2028, specialising in Systems, Control and Automation.' },
  ...
  { q: ['education', 'college', 'degree', 'university', 'study', 'cgpa'], a: 'M.Tech at IIT Guwahati (2026–2028) after a B.Tech in Electrical Engineering at GKCIET Malda (2022–2026).' },
  ...
  { q: ['voice', 'audio', 'mfcc', 'speech'], a: 'The voice project separates human from AI-generated speech at 89% accuracy: MFCC features from 1,500+ samples, spectral-gating noise reduction cutting interference by 65%, and a Random Forest on a 15-D feature vector that beat an SVM baseline by 12%. ' },
  ...
  { q: ['resume', 'cv', 'download'], a: 'The résumé is on this page in the Résumé section — a one-page IIT Guwahati format PDF you can download directly.' },
];
