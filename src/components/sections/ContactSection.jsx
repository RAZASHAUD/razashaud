...
import { Copy, Check, Download, Linkedin, Github, Calendar, Send } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-5">
        ...
        <div className="grid lg:grid-cols-[1fr_1.15fr] gap-10">
          <div className="space-y-3">
            ...
            {profile.calendar && (
              <a href={profile.calendar} target="_blank" rel="noopener noreferrer" className="panel panel-hover p-5 flex items-center justify-between gap-4">
                <div>
                  <div className="readout">book a call</div>
                  <div className="text-sm mt-1">Pick any slot that works</div>
                </div>
