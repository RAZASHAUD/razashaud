        ...
        <div className="grid lg:grid-cols-[1.35fr_1fr] gap-12 lg:gap-16 items-center">
          <div>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}
              ...
              <button onClick={() => scrollToSection('bench')} className="btn btn-solid">
                Try the live demos <ArrowRight size={16} />
              </button>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.15 }}>
            <div className="panel p-2">
              ...
              <div className="flex items-center justify-between px-2 py-2">
                <span className="readout">IIT Guwahati · M.Tech</span>
                <span className="readout text-trace">GATE AIR 2139</span>
              </div>
            </div>
          </motion.div>
        </div>
