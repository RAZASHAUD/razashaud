...
const SECTIONS = ['home', 'projects', 'skills', 'experience', 'research', 'resume', 'contact'];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Machine learning on sensor data, embedded systems and control. Three published papers including an IEEE Best Paper Award. Résumé and project case studies." />
        <meta property="og:type" content="profile" />
        <meta name="twitter:card" content="summary_large_image" />
      </Helmet>

      <a href="#projects" className="sr-only focus:not-sr-only focus:fixed focus:top-3 focus:left-3 focus:z-[70] btn btn-solid">
        Skip to projects
      </a>
